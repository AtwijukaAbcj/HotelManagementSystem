...
<script src="{{ URL::to('admin/assets/plugins/datatables/datatables.min.js')}} "></script>
<script src="{{ URL::to('admin/assets/plugins/datatables/dataTables.responsive.min.js')}} "></script>
<script src="{{ URL::to('admin/assets/plugins/datatables/responsive.bootstrap4.min.js')}} "></script>
<script src="{{ URL::to('admin/assets/plugins/datatables/jszip.min.js')}} "></script>
<script src="{{ URL::to('admin/assets/plugins/datatables/pdfmake.min.js')}} "></script>
<script src="{{ URL::to('admin/assets/plugins/datatables/vfs_fonts.js')}} "></script>
<script src="{{ URL::to('admin/assets/plugins/datatables/dataTables.buttons.min.js')}} "></script>
<script src="{{ URL::to('admin/assets/plugins/datatables/buttons.bootstrap4.min.js')}} "></script>
<script src="{{ URL::to('admin/assets/plugins/datatables/buttons.html5.min.js')}} "></script>
<script src="{{ URL::to('admin/assets/plugins/datatables/buttons.print.min.js')}} "></script>
<script src="{{ URL::to('admin/assets/plugins/datatables/buttons.colVis.min.js')}} "></script>

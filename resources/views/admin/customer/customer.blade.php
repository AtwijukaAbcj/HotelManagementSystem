...
<body>
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            @php($deleteCustomer = $data instanceof \Illuminate\Support\Collection ? $data->last() : $data)
            @if($deleteCustomer)
                    ...
                    <div class="modal-content">
                        <div class="modal-body text-center"> <img src="{{URL::to('admin/assets/img/sent.png')}}" alt="" width="50" height="46">
                            ...
                            <div class="m-t-20"> <a href="#" class="btn btn-white" data-dismiss="modal">Close</a>
                                <a class="btn btn-danger" href="{{url('delete_record',$deleteCustomer->id)}}">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>

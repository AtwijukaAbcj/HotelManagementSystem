...
<body>
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form action="">
                            <div class="row formtype">
                                ...
                                <div class="col-md-3"><div class="form-group"><select name="property_id" class="form-control"><option value="">All properties</option>@foreach($properties as $property)<option value="{{ $property->id }}" @selected(request('property_id') == $property->id)>{{ $property->name }}</option>@endforeach</select></div></div>
                                <div class="col-md-3">
                                    <div class="form-group">
            ...
            @php($deleteBooking = $data instanceof \Illuminate\Support\Collection ? $data->last() : $data)
            @if($deleteBooking)
                    ...
                    <div class="modal-content">
                        <div class="modal-body text-center"> <img src="{{URL::to('admin/assets/img/sent.png')}}" alt="" width="50" height="46">
                            ...
                            <div class="m-t-20"> <a href="#" class="btn btn-white" data-dismiss="modal">Close</a>
                                <a class="btn btn-danger" href="{{url('delete_record',$deleteBooking->id)}}">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
